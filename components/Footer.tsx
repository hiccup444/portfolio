    ...
    <footer id="contact" className="bg-dark-900 border-t border-white/10 py-12">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <div className="flex justify-center gap-6 mb-8">
            <a href="https://github.com/hiccup444" className="p-3 rounded-full bg-white/5 hover:bg-neon-blue hover:text-black transition-all text-gray-400">
                <Github size={20} />
            </a>
            <a href="https://discordapp.com/users/861886425548980254" className="p-3 rounded-full bg-white/5 hover:bg-[#5865F2] hover:text-white transition-all text-gray-400" aria-label="Discord">
            ...
            <a href="mailto:garystambaugh.business@gmail.com" className="p-3 rounded-full bg-white/5 hover:bg-neon-blue hover:text-black transition-all text-gray-400">
                <Mail size={20} />
            </a>
        </div>
